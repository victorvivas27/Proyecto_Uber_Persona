...
public class ClienteController implements IClienteController {
    ...
    public ResponseEntity<ApiResponse<ToClienteSalida>> crearCliente(@RequestBody @Valid ToClienteEntrada toClienteEntrada) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ApiResponse<>(ConstantesCliente.CLIENTE_CREADO, HttpStatus.CREATED.value(), toClienteSalida));
    }
    ...
    public ResponseEntity<ApiResponse<List<ToClienteSalida>>> listarClientes() {
        ...
        ApiResponse<List<ToClienteSalida>> response = new ApiResponse<>(ConstantesCliente.LISTA_CLIENTE, HttpStatus.OK.value(), toClienteSalidas);
    ...
    public ResponseEntity<ApiResponse<ToClienteSalida>> buscarClienteID(@PathVariable Long idCliente) throws ResourceNotFoundException {
        ...
        ApiResponse<ToClienteSalida> response = new ApiResponse<>(ConstantesCliente.CLIENTE_ENCONTRADO, HttpStatus.OK.value(), toClienteSalida);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<ToClienteSalida>> modificarCLiente(@Valid @RequestBody ToClienteModificar toClienteModificar) throws ResourceNotFoundException {
        ...
        ApiResponse<ToClienteSalida> response = new ApiResponse<>(ConstantesCliente.CLIENTE_MODIFICADO, HttpStatus.OK.value(), toClienteSalida);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Long>> eliminarCliente(@PathVariable Long idCliente) throws ResourceNotFoundException {
        ...
        ApiResponse<Long> response = new ApiResponse<>(ConstantesCliente.CLIENTE_ELIMINADO, HttpStatus.OK.value(), idCliente);
        return ResponseEntity.ok(response);
    }
}